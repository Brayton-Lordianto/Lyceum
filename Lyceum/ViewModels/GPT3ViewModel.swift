...
class GPT3ViewModel: ObservableObject {
    ...
    private func getResponseSingle(prompt: String) async -> String {
        let header = "You will act as a machine that generates exactly what I ask you to generate as long as it is appropriate. do not address me as a human, and do not do anything more than you are asked to."
