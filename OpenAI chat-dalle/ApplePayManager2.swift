...
func startPayment(completion: @escaping PaymentCompletionHandler) {
    ...
    let tax = PKPaymentSummaryItem(label: "Tax", amount: NSDecimalNumber(string: "0"), type: .final)
    ...
    paymentRequest.merchantIdentifier = "merchant.MF.Lyceum"
